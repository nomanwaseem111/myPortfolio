...
const Banner = () => {
  ...
  return (
    ...
    <Grid sx={{ height: { md: "auto" }}} overflow={{xs:"hidden"}} maxWidth="xxl" width={{xs:"100%"}}  id="banner" backgroundColor={{md:"#171c28",xs:"#171c28"}}>
        ...
        <Stack sx={{ width: { md: "100%", xs: "100%", lg: "100%" }, height: { xs: "680px", md: "650px",sm:"700px" }, }}>
        <Fade bottom duration={1500}>
          ...
          >
            ...
            >
             ...
             <Stack mt={{md:"40px",xs:'30px',sm:"40px"}}   width={{xs:"100%",md:"800px",sm:"100%",lg:"900px"}} margin={{sm:"auto"}} display={{md:"flex",xs:"flex",lg:"flex",sm:"flex"}} flexwrap={{md:"wrap",xs:'wrap',lg:"wrap",sm:"wrap"}} justifyContent={{md:"center",xs:"center",lg:"center",sm:"center"}} alignItems={{md:"center",xs:"center",lg:"center",sm:"center"}}>
              <Typography
                variant="h4"
                sx={{
                  ...
                  marginRight:{md:'120px',xs:'20px',sm:"30px"},
...
Web & App Developer
  ...
  width={{md:"320px",lg:'320px',xs:'280px',sm:"275px"}}  direction={{md:"row",xs:"row",lg:"row",sm:"row"}} spacing={4} mt={{md:"42px",xs:"40px",lg:'42px',sm:"40px"}} >
            ...
            <Box margin={{md:"auto",xs:"auto"}} sx={{width:{md:"600px",xs:"350px",lg:"1600px",sm:"400px"},mt:{xs:"150px",md:"0px",sm:'100px'}}} >
